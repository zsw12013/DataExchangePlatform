...
import zhousw.sys.dao.SysUserDao;
...
@com.alibaba.dubbo.config.annotation.Service(interfaceClass=zhousw.sys.facade.SysUserFacade.class, protocol = {"rest", "dubbo"})
public class SysUserService implements SysUserFacade {
	...
	public JSONObject getById(String id) {
		//get
		//http://localhost:8888/zhousw-sys-service/sysUserService/getById/{id}
